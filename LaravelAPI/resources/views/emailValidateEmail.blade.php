<div style="width: 600px; margin: 0 auto">
    <div style="text-align:center">
        ...
        <p>
            <a href="{{route('customer.actived', ['customer'=>$newCustomer->customer_id, 'token'=>$newCustomer->customer_token])}}" style="display:inline-block; background: green; color: #fff; padding: 7px 25px; font-weight:bold">Verify Email</a>
        </p>
    </div>
