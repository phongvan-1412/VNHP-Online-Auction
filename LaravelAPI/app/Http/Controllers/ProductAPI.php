...
class ProductAPI extends Controller
{
    ...
    public function AddProduct(Request $request){
        ...
        if(!$isExist)
        {
            ...
            $product_img_name1->move(public_path('ProductImg'),  time().'-'.'product1'.$request->img_extension1);
            $product_img_name2->move(public_path('ProductImg'),  time().'-'.'product2'.$request->img_extension2);
            $product_img_name3->move(public_path('ProductImg'),  time().'-'.'product3'.$request->img_extension3);
