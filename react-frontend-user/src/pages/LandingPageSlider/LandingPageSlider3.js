        ...
        res.map((products) => {
            var countDownDate = new Date("Jan 5, 2024 15:37:25").getTime();
                var slider3 = setInterval(function() {
                  ...
                  if (
                    document.getElementById('slider3' + products.product_id + products.product_name) == null
                  )
                    return;
                  if (
                    document.getElementById('slider3' + products.product_id + products.product_name) ==
                      null ||
                    distance < 0
                  ) {
          ...
          const tmp_countdown = document.createElement("div");
            tmp_countdown.id = 'slider3' + products.product_id + products.product_name;
            tmp_countdown.innerHTML = slider3;
          ...
          $("#product-grid-wrapper3").append(tmp);
        });
      });
  }
  getData();
