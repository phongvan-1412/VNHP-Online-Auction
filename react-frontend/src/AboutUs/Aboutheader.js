            ...
            <nav className="u-menu u-menu-one-level u-offcanvas u-menu-1">
                ...
                <Link className="u-button-style u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-top-bottom-menu-spacing u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" to="#">
                    <svg className="u-svg-link" viewBox="0 0 24 24">
                        {/* <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:to="#menu-hamburger"></use> */}
                    </svg>
                ...
                <ul className="u-nav u-unstyled u-nav-1">
                    <li className="u-nav-item">
                        <Link className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" to="#" style={{padding: "10px 18px"}}>Home</Link>
                    </li>
                    <li className="u-nav-item">
                        <Link className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" to="#" style={{padding: "10px 18px"}}>About</Link>
                    </li>
                    <li className="u-nav-item">
                        <Link className="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" to="#" style={{padding: "10px 18px"}}>Contact</Link>
                    </li>
                    <li className="u-nav-item">
                ...
                <div className="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                    ...
                    <ul className="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                        ...
                        <li className="u-nav-item">
                            <Link className="u-button-style u-nav-link" to="#">About</Link>
                        </li>
                        <li className="u-nav-item">
                            <Link className="u-button-style u-nav-link" to="#">Contact</Link>
                        </li>
                        <li className="u-nav-item">
